...
Please analyze the document content according to all the user prompts and provide a comprehensive, detailed response addressing each prompt."""
    ...
    analysis = {
        ...
        "prompt_ids": analysis_request.prompt_ids,
